...
class AcceptReceiver:BroadcastReceiver() {
    ...
    override fun onReceive(p0: Context?, p1: Intent?) {
        ...
        val from = p1?.getStringExtra(p0?.getString(R.string.from))

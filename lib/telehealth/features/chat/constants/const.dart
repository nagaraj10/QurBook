...
final themeColor = Color(0XFF6d35de);
final primaryColor = Color(0xffffffff);
final greyColor = Color(0xffaeaeae);
final greyColor2 = Color(0xffE8E8E8);

const popUpChoiceOne = 'Search';
...
const pushMessageText = 'New message from ';
...
//prod
const String firebaseCloudserverToken = 'AAAA9UvO5fM:APA91bGaRuI7HrZmpIc0XUmEJ_toWEBOQMLGGm4MJ7E_bVSmNz6TDGb_aRCCgDw5ON1BtNbpds-VyoJKTTLJqY_u2xkmVpIIZv_jt_vRElbXSeWLB16w3oPr3xC8BgGuyNbpd1-R6Usr';

...
class LaboratoryIds {
  ...
  Map<String, dynamic> toJson() {
    ...
    data[parameters.strentityCode] = this.entityCode;
    data[parameters.strgoFhbCode] = this.goFhbCode;
    data[parameters.strlabPatientMappingId] = this.labPatientMappingId;
    return data;
  }
}

...
import 'package:myfhb/dashboard/smile_painter.dart';
...
class _MyReviewPageState extends State<MyReviewPage>
  ...
  void initState() {
    ...
    badArcItem = ArcItem(Icon(Icons.add_alarm), "BAD",
        [Color(0xFFfe0944), Color(0xFFfeae96)], 0.0);
    ughArcItem = ArcItem(Icon(Icons.add_alarm), "UGH",
        [Color(0xFFF9D976), Color(0xfff39f86)], 0.0);
    okArcItem = ArcItem(Icon(Icons.add_alarm), "OK",
        [Color(0xFF21e1fa), Color(0xff3bb8fd)], 0.0);
    goodArcItem = ArcItem(Icon(Icons.add_alarm), "GOOD",
        [Color(0xFF3ee98a), Color(0xFF41f7c7)], 0.0);

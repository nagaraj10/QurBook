...
String createTicketModelToJson(CreateTicketModel data) =>
...
final descriptionValues =
    EnumValues({"Default role for users": Description.DEFAULT_ROLE_FOR_USERS});
...
final roleNameValues = EnumValues({"User": RoleName.USER});

enum Normalized { USER }

final normalizedValues = EnumValues({"user": Normalized.USER});

enum TitleEnum { PATIENT }

final titleEnumValues = EnumValues({"Patient": TitleEnum.PATIENT});
...
class Preferences {
  ...
  factory Preferences.fromJson(Map<String, dynamic> json) => Preferences(
        ...
        openChatWindows:
            List<dynamic>.from(json["openChatWindows"].map((x) => x)),
      );

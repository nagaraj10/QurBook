...
const String CT_COUNTRY_METRICS = "CREATE TABLE CountryMetrics(countryCode INTEGER PRIMARY KEY, name TEXT, bpSPUnit TEXT, bpDPUnit TEXT,bpPulseUnit TEXT, glucometerUnit TEXT, poOxySatUnit TEXT,poPulseUnit TEXT, tempUnit TEXT, weightUnit TEXT)";
const String CT_UNITS = "CREATE TABLE UnitsTable (id INTEGER PRIMARY KEY, units TEXT,minValue INTEGER,maxValue INTEGER)";
...
const String CM_QUERY_BY_CC = 'SELECT * FROM CountryMetrics WHERE countryCode = ';
const String CM_DEL_QUERY_BY_CC = 'DELETE FROM CountryMetrics WHERE countryCode = ?';

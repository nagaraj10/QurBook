...
class Call1Page extends StatefulWidget {
  ...
  const Call1Page({Key key, this.channelName, this.role}) : super(key: key);

  @override
  _Call1PageState createState() => _Call1PageState();
}
...
Widget _prescription(BuildContext context) {
  return Container(

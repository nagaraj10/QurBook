...
class FetchGoogleFitData {
  ...
  Future<String> getBloodGlucoseSummary(String startTime, String endTime) async {
  ...
  Future<String> getOxygenSaturationSummary(String startTime, String endTime) async {

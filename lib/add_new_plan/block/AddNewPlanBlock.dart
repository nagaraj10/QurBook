...
class AddNewBlock implements BaseBloc {
  ...
  StreamSink<ApiResponse<AddPlanSuccessResponse>> get addPlanSink =>
      addPlanController!.sink
          as StreamSink<ApiResponse<AddPlanSuccessResponse>>;
  ...
  AddNewBlock() {
    addPlanController = StreamController<ApiResponse<AddPlanSuccessResponse>>();
  }
  ...
  Future<List<PlanCodeResult>?> getPlanCode() async {
    ...
    planCode = await resposiory.getPlanCode();

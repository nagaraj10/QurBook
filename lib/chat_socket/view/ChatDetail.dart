...
class ChatState extends State<ChatDetail> {
      ...
      itemBuilder: (context) => [
            PopupMenuItem(
              ...
              child: Text(
                '$popUpChoiceOne',
                style: TextStyle(
                  fontSize: (CommonUtil().isTablet ?? false) ? 22.0.sp :16.0.sp,
                ),
              ),
            ),
            /* PopupMenuItem(
  ...
  Widget getTopBookingDetail() {
    if (isFromCareCoordinator! &&
      ...
      return Text('Name: ' + careCoordinatorName,
          ...
          style: TextStyle(
              fontFamily: font_poppins,
              fontSize: (CommonUtil().isTablet ?? false) ? 18.0.sp :12.0.sp,
              color: Colors.white));
    } else {
      if (!isCareGiverApi) {
                        ...
                        child: RichText(
                          ...
                          text: TextSpan(
                              style: TextStyle(
                                ...
                                fontSize: (CommonUtil().isTablet ?? false) ? 20.0.sp :14.0.sp,
                              ),
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    RichText(
                                      text: TextSpan(
                                          style: TextStyle(color: Colors.white,fontSize: (CommonUtil().isTablet ?? false) ? 20.0.sp :14.0.sp,),
                                          children: textSpanList),
                                    ),
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Click to view PDF',
                                                style: TextStyle(
                                                    color: Colors.white,fontSize: (CommonUtil().isTablet ?? false) ? 22.0.sp :16.0.sp,),
                                              ),
                                            ],
                                          ),
                                        ),
  ...
  Widget getWidgetTextForLastReceivedDate(String value) {
    return Text(
      ...
      maxLines: 1,
      style: TextStyle(
          fontFamily: font_poppins, fontSize: (CommonUtil().isTablet ?? false) ? 18.0.sp :12.0.sp, color: Colors.white),
    );
  }
      ...
      (chatList?.messages?.isSentViaSheela ?? false)
        ...
        margin: EdgeInsets.only(top: 5.0),
            child: Text(
                ...
                style: TextStyle(
                    color: color, fontSize: (CommonUtil().isTablet ?? false) ? 20.0.sp :14.0.sp, fontStyle: FontStyle.italic),
              ),
          )
          : SizedBox.shrink();
}

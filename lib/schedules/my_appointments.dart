...
class MyAppointment extends StatefulWidget {
  ...
  static _MyAppointmentState of(BuildContext context) => context.findAncestorStateOfType<State<MyAppointment>>();
            ...
            home: new Scaffold(
              ...
              floatingActionButton: FloatingActionButton.extended(
                onPressed: () {
                  ...
                  showDialog(context: context,barrierDismissible: false,builder: (BuildContext contxt){
                    return _MyCustomAlertDialog(title:'New appointment',subtitle:'Save',context: context,actionText:'Save');
                  });
                },
                label: Text('Add'),
                icon: Icon(Icons.add),
                ...
                child: RaisedGradientButton(
                  ...
                  onPressed: () async {
                    if (nameHos.text.isEmpty || nameDoc.text.isEmpty) {
                      ...
                      AppointmentModel model = new AppointmentModel(id: DateTime.now().millisecondsSinceEpoch.toString(), hName: nameHos.text, dName: nameDoc.text,
                          appDate: DateTime.now().toString(),reason: reason.text);

...
class _HubListScreenState extends State<HubListScreen> {
  HubListController controller = Get.find();
  ...
  Widget pairNewVirtualHubBtn() {
      ...
      onTap: () async {
        try {
          if (controller.hubListResponse.result != null &&
              ...
              controller
                  .hubListResponse.result.hub.additionalDetails.isVirtualHub) {
    ...
    return Center(
        child: Obx(
      () => controller.searchingBleDevice.isTrue
          ? Row(
